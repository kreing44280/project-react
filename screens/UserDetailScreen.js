...
class UserDetailScreen extends Component{
    ...
    componentDidMount() {
        const dbRef = firebase.firestore().collection('react-native').doc(this.props.route.params.userKey)
        dbRef.get().then((res) => {
            if (res.exists){
                const user = res.data()
                this.setState({
    ...
    updateUser() {
        ...
        const updateDBRef = firebase.firestore().collection("react-native").doc(this.state.key)
        updateDBRef.set({
